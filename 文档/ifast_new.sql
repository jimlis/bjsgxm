...
CREATE TABLE `sys_dept` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1024978193859248131 DEFAULT CHARSET=utf8 COMMENT='部门管理';
...
CREATE TABLE `sys_file` (
  ...
  `createDate` datetime DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1026284939676491779 DEFAULT CHARSET=utf8 COMMENT='文件上传';
...
INSERT INTO `sys_file` VALUES ('1026284939676491778', '99', 'http://p6r7ke2jc.bkt.clouddn.com/ifast/20180806/composer-1533520371282.json', '2018-08-06 09:52:52');
...
INSERT INTO `sys_menu` VALUES ('151', '1', '公司信息管理', '/sign/appCompany', null, '1', 'fa fa-file-code-o', '6', null, null);
INSERT INTO `sys_menu` VALUES ('152', '151', '查看', null, 'sign:appCompany:appCompany', '2', null, '6', null, null);
INSERT INTO `sys_menu` VALUES ('153', '151', '新增', null, 'sign:appCompany:add', '2', null, '6', null, null);
INSERT INTO `sys_menu` VALUES ('154', '151', '修改', null, 'sign:appCompany:edit', '2', null, '6', null, null);
INSERT INTO `sys_menu` VALUES ('155', '151', '删除', null, 'sign:appCompany:remove', '2', null, '6', null, null);
INSERT INTO `sys_menu` VALUES ('156', '151', '批量删除', null, 'sign:appCompany:batchRemove', '2', null, '6', null, null);
INSERT INTO `sys_menu` VALUES ('157', '1', '出差管理', '/sign/appOutWork', null, '1', 'fa fa-file-code-o', '6', null, null);
INSERT INTO `sys_menu` VALUES ('158', '157', '查看', null, 'sign:appOutWork:appOutWork', '2', null, '6', null, null);
INSERT INTO `sys_menu` VALUES ('159', '157', '新增', null, 'sign:appOutWork:add', '2', null, '6', null, null);
INSERT INTO `sys_menu` VALUES ('160', '157', '修改', null, 'sign:appOutWork:edit', '2', null, '6', null, null);
INSERT INTO `sys_menu` VALUES ('161', '157', '删除', null, 'sign:appOutWork:remove', '2', null, '6', null, null);
INSERT INTO `sys_menu` VALUES ('162', '157', '批量删除', null, 'sign:appOutWork:batchRemove', '2', null, '6', null, null);
INSERT INTO `sys_menu` VALUES ('163', '1', '考勤管理', '/sign/appSign', null, '1', 'fa fa-file-code-o', '6', null, null);
INSERT INTO `sys_menu` VALUES ('164', '163', '查看', null, 'sign:appSign:appSign', '2', null, '6', null, null);
INSERT INTO `sys_menu` VALUES ('165', '163', '新增', null, 'sign:appSign:add', '2', null, '6', null, null);
INSERT INTO `sys_menu` VALUES ('166', '163', '修改', null, 'sign:appSign:edit', '2', null, '6', null, null);
INSERT INTO `sys_menu` VALUES ('167', '163', '删除', null, 'sign:appSign:remove', '2', null, '6', null, null);
INSERT INTO `sys_menu` VALUES ('168', '163', '批量删除', null, 'sign:appSign:batchRemove', '2', null, '6', null, null);
INSERT INTO `sys_menu` VALUES ('169', '1', '员工管理', '/sign/appUser', null, '1', 'fa fa-file-code-o', '6', null, null);
INSERT INTO `sys_menu` VALUES ('170', '169', '查看', null, 'sign:appUser:appUser', '2', null, '6', null, null);
INSERT INTO `sys_menu` VALUES ('171', '169', '新增', null, 'sign:appUser:add', '2', null, '6', null, null);
INSERT INTO `sys_menu` VALUES ('172', '169', '修改', null, 'sign:appUser:edit', '2', null, '6', null, null);
INSERT INTO `sys_menu` VALUES ('173', '169', '删除', null, 'sign:appUser:remove', '2', null, '6', null, null);
INSERT INTO `sys_menu` VALUES ('174', '169', '批量删除', null, 'sign:appUser:batchRemove', '2', null, '6', null, null);
...
INSERT INTO `sys_menu` VALUES ('199', '1', '', '/temp/configCopy', null, '1', 'fa fa-file-code-o', '6', null, null);
...
CREATE TABLE `sys_role` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1026453924414033922 DEFAULT CHARSET=utf8 COMMENT='角色';
...
INSERT INTO `sys_role` VALUES ('1026075219917352962', '3423', null, '234', null, null, null);
INSERT INTO `sys_role` VALUES ('1026075249659162626', '3423', null, '234', null, null, null);
INSERT INTO `sys_role` VALUES ('1026080535333617665', '323', null, '31', null, null, null);
INSERT INTO `sys_role` VALUES ('1026091495477809153', '2313', null, '123', null, null, null);
INSERT INTO `sys_role` VALUES ('1026092515234697218', '312', null, '131', null, null, null);
INSERT INTO `sys_role` VALUES ('1026453924414033921', '231', null, '123', null, null, null);
...
INSERT INTO `sys_role_menu` VALUES ('4308', '1', '79');
INSERT INTO `sys_role_menu` VALUES ('4309', '1', '80');
INSERT INTO `sys_role_menu` VALUES ('4310', '1', '81');
INSERT INTO `sys_role_menu` VALUES ('4311', '1', '83');
INSERT INTO `sys_role_menu` VALUES ('4312', '1', '176');
INSERT INTO `sys_role_menu` VALUES ('4313', '1', '177');
INSERT INTO `sys_role_menu` VALUES ('4314', '1', '178');
INSERT INTO `sys_role_menu` VALUES ('4315', '1', '179');
INSERT INTO `sys_role_menu` VALUES ('4316', '1', '180');
INSERT INTO `sys_role_menu` VALUES ('4317', '1', '20');
INSERT INTO `sys_role_menu` VALUES ('4318', '1', '21');
INSERT INTO `sys_role_menu` VALUES ('4319', '1', '22');
INSERT INTO `sys_role_menu` VALUES ('4320', '1', '61');
INSERT INTO `sys_role_menu` VALUES ('4321', '1', '12');
INSERT INTO `sys_role_menu` VALUES ('4322', '1', '13');
INSERT INTO `sys_role_menu` VALUES ('4323', '1', '14');
INSERT INTO `sys_role_menu` VALUES ('4324', '1', '24');
INSERT INTO `sys_role_menu` VALUES ('4325', '1', '25');
INSERT INTO `sys_role_menu` VALUES ('4326', '1', '26');
INSERT INTO `sys_role_menu` VALUES ('4327', '1', '15');
INSERT INTO `sys_role_menu` VALUES ('4328', '1', '55');
INSERT INTO `sys_role_menu` VALUES ('4329', '1', '56');
INSERT INTO `sys_role_menu` VALUES ('4330', '1', '62');
INSERT INTO `sys_role_menu` VALUES ('4331', '1', '74');
INSERT INTO `sys_role_menu` VALUES ('4332', '1', '75');
INSERT INTO `sys_role_menu` VALUES ('4333', '1', '76');
INSERT INTO `sys_role_menu` VALUES ('4334', '1', '48');
INSERT INTO `sys_role_menu` VALUES ('4335', '1', '72');
INSERT INTO `sys_role_menu` VALUES ('4336', '1', '28');
INSERT INTO `sys_role_menu` VALUES ('4337', '1', '29');
INSERT INTO `sys_role_menu` VALUES ('4338', '1', '30');
INSERT INTO `sys_role_menu` VALUES ('4339', '1', '57');
INSERT INTO `sys_role_menu` VALUES ('4340', '1', '92');
INSERT INTO `sys_role_menu` VALUES ('4341', '1', '78');
INSERT INTO `sys_role_menu` VALUES ('4342', '1', '175');
INSERT INTO `sys_role_menu` VALUES ('4343', '1', '2');
INSERT INTO `sys_role_menu` VALUES ('4344', '1', '6');
INSERT INTO `sys_role_menu` VALUES ('4345', '1', '7');
INSERT INTO `sys_role_menu` VALUES ('4346', '1', '73');
INSERT INTO `sys_role_menu` VALUES ('4347', '1', '3');
INSERT INTO `sys_role_menu` VALUES ('4348', '1', '77');
INSERT INTO `sys_role_menu` VALUES ('4349', '1', '27');
INSERT INTO `sys_role_menu` VALUES ('4350', '1', '91');
INSERT INTO `sys_role_menu` VALUES ('4351', '1', '71');
INSERT INTO `sys_role_menu` VALUES ('4352', '1', '193');
INSERT INTO `sys_role_menu` VALUES ('4353', '1', '194');
INSERT INTO `sys_role_menu` VALUES ('4354', '1', '195');
INSERT INTO `sys_role_menu` VALUES ('4355', '1', '196');
INSERT INTO `sys_role_menu` VALUES ('4356', '1', '197');
INSERT INTO `sys_role_menu` VALUES ('4357', '1', '-1');
INSERT INTO `sys_role_menu` VALUES ('4358', '1', '1');
...
INSERT INTO `sys_task` VALUES ('1020572889410367490', 'ddd', null, null, 'eee', null, 'ccc', null, '0', 'bbb', null, null, null, 'aaa');
...
CREATE TABLE `sys_user` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1026106648302796802 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES ('1', 'admin', '超级管理员', '33808479d49ca8a3cdc93d4f976d1e3d', '6', 'izenglong@163.com', '15277778888', '1', '1', '2017-08-15 21:40:39', '2017-08-15 21:41:00', '96', '2018-04-02 00:00:00', '151', '创客基地', null, '广东省', '广州市', '番禺区');
INSERT INTO `sys_user` VALUES ('2', 'test', '临时用户', 'b132f5f968c9373261f74025c23c2222', '6', 'test@bootdo.com', null, '1', '1', '2017-08-14 13:43:05', '2017-08-14 21:15:36', null, null, null, null, null, null, null, null);
INSERT INTO `sys_user` VALUES ('36', 'ldh', '刘德华', 'bfd9394475754fbe45866eba97738c36', '6', 'ldh@bootdo.com1', null, '1', null, null, null, null, null, null, null, null, null, null, null);
INSERT INTO `sys_user` VALUES ('123', 'zxy', '张学友', '35174ba93f5fe7267f1fb3c1bf903781', '6', 'zxy@bootdo', null, '1', null, null, null, null, null, null, null, null, null, null, null);
...
INSERT INTO `sys_user` VALUES ('131', 'lhc', '令狐冲', 'd515538e17ecb570ba40344b5618f5d4', '6', 'lhc@bootdo.com', null, '1', null, null, null, null, null, null, null, null, null, null, null);
...
INSERT INTO `sys_user` VALUES ('136', 'gdg', '郭德纲', '3bb1bda86bc02bf6478cd91e42135d2f', '9', 'gdg@bootdo.com1', null, '1', null, null, null, null, null, null, null, null, null, null, null);
INSERT INTO `sys_user` VALUES ('137', 'sign123', 'sign123', '1e3d9b9fb85ecfc0041f5b944e6a7854', '15', 'sign@sign.com', null, '1', null, null, null, null, null, null, null, null, null, null, null);
INSERT INTO `sys_user` VALUES ('1026106648302796801', 'test111', 'test', 'f27cee7947a9b78c4ddb92049f23e752', '7', '634738611@qq.com', null, '1', null, null, null, null, null, null, null, null, null, null, null);
...
INSERT INTO `sys_user_role` VALUES ('132', '1026106648302796801', '1026092515234697218');
